...
|---|---|---|---|---|
| Strict local Qwen conversational turn | Current | Yes: `Controller`, schema-v2 validation, bounded corrective retry | Yes, typed CLI and resident/browser turn coordinator | 3090 router deployed; current UI baseline physically accepted |
