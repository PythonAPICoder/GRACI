...
> [`governance/CURRENT_POLICY.md`](governance/CURRENT_POLICY.md), with stable policy
> IDs in [`governance/POLICY_INDEX.md`](governance/POLICY_INDEX.md). Phase records
